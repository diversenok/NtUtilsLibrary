...
type
  ...
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerCodeGen) shl PS_PROTECTED_SIGNER_SHIFT, 'CodeGen')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerAntimalware) shl PS_PROTECTED_SIGNER_SHIFT, 'Antimalware')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerLsa) shl PS_PROTECTED_SIGNER_SHIFT, 'LSA')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerWindows) shl PS_PROTECTED_SIGNER_SHIFT, 'Windows')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerWinTcb) shl PS_PROTECTED_SIGNER_SHIFT, 'WinTcb')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerWinSystem) shl PS_PROTECTED_SIGNER_SHIFT, 'WinSystem')]
  [SubEnum(PS_PROTECTED_SIGNER_MASK, Cardinal(PsProtectedSignerApp) shl PS_PROTECTED_SIGNER_SHIFT, 'App')]
  [SubEnum(PS_PROTECTED_TYPE_MASK, Cardinal(PsProtectedTypeNone), 'No protection')]

...
const
  ...
  PROCESS_CREATE_FLAGS_LARGE_PAGES = $00000010;           // SeLockMemory
  PROCESS_CREATE_FLAGS_LARGE_PAGE_SYSTEM_DLL = $00000020; // SeLockMemory
  PROCESS_CREATE_FLAGS_PROTECTED_PROCESS = $00000040;
  PROCESS_CREATE_FLAGS_CREATE_SESSION = $00000080;        // SeLoadDriver
  PROCESS_CREATE_FLAGS_INHERIT_FROM_PARENT = $00000100;
  PROCESS_CREATE_FLAGS_SUSPENDED = $00000200;
  PROCESS_CREATE_FLAGS_FORCE_BREAKAWAY = $00000400;       // SeTcb
  PROCESS_CREATE_FLAGS_MINIMAL_PROCESS = $00000800;
  PROCESS_CREATE_FLAGS_RELEASE_SECTION = $00001000;
  PROCESS_CREATE_FLAGS_AUXILIARY_PROCESS = $00008000;     // SeTcb

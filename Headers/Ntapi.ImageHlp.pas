...
type
  ...
  [SubEnum(MAX_WORD, IMAGE_FILE_MACHINE_ARMNT, 'ARM')]
  [SubEnum(MAX_WORD, IMAGE_FILE_MACHINE_IA64, 'IA64')]
  [SubEnum(MAX_WORD, IMAGE_FILE_MACHINE_AMD64, 'AMD64')]
  [SubEnum(MAX_WORD, IMAGE_FILE_MACHINE_ARM64, 'ARM64')]
  TImageMachine16 = type Word;

  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_I386, 'i386')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_ARMNT, 'ARM')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_IA64, 'IA64')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_AMD64, 'AMD64')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_ARM64, 'ARM64')]

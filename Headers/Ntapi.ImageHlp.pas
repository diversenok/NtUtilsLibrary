...
type
  ...
  [NamingStyle(nsSnakeCase, 'IMAGE_FILE_MACHINE')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_I386, 'IMAGE_FILE_MACHINE_I386')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_ARM, 'IMAGE_FILE_MACHINE_ARM')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_THUMB, 'IMAGE_FILE_MACHINE_THUMB')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_ARMNT, 'IMAGE_FILE_MACHINE_ARMNT')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_IA64, 'IMAGE_FILE_MACHINE_IA64')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_AMD64, 'IMAGE_FILE_MACHINE_AMD64')]
  [SubEnum(MAX_UINT, IMAGE_FILE_MACHINE_ARM64, 'IMAGE_FILE_MACHINE_ARM64')]
  TImageMachine32 = type Cardinal;

  [InheritsFrom(System.TypeInfo(TImageMachine32))]

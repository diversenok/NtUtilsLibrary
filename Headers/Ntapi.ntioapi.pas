...
function NtCreateNamedPipeFile(out FileHandle: THandle; DesiredAccess:
  ...
  TIoStatusBlock; ShareAccess: Cardinal; CreateDisposition: TFileDisposition;
  CreateOptions: Cardinal; NamedPipeType: Cardinal; ReadMode: TFilePipeReadMode;
  CompletionMode: TFilePipeCompletion; MaximumInstances: Cardinal; InboundQuota:
  Cardinal; OutboundQuota: Cardinal; DefaultTimeout: PULargeInteger): NTSTATUS;

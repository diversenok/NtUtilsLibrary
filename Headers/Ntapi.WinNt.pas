...
const
  ...
  DOMAIN_USER_RID_ADMIN = $000001F4;  // S-1-5-21-...-500 (Administrator)
  DOMAIN_USER_RID_GUEST = $000001F5;  // S-1-5-21-...-501 (Guest)
  DOMAIN_USER_RID_DEFAULT_ACCOUNT = $000001F7; // S-1-5-21-...-503 (DefaultAccount)
  DOMAIN_USER_RID_WDAG_ACCOUNT = $000001F8;    // S-1-5-21-...-504 (WDAGUtilityAccount)
  ...
  SECURITY_LOCAL_ACCOUNT_RID = $00000071;           // S-1-5-113 (NT AUTHORITY\Local account)
  SECURITY_LOCAL_ACCOUNT_AND_ADMIN_RID = $00000072; // S-1-5-114 (NT AUTHORITY\Local account and member of Administrators group)

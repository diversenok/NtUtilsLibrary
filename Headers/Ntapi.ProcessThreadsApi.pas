...
const
  ...
  INHERIT_CALLER_PRIORITY = $00020000;
  ...
  // SDK::WinBase.h, Win 8+
  MITIGATION_POLICY_FORCE_RELOCATE_IMAGES_ALWAYS_ON  = UInt64($1) shl 8;
  MITIGATION_POLICY_FORCE_RELOCATE_IMAGES_ALWAYS_OFF = UInt64($2) shl 8;
  MITIGATION_POLICY_FORCE_RELOCATE_IMAGES_ALWAYS_ON_REQ_RELOCS = UInt64($3) shl 8;

  MITIGATION_POLICY_HEAP_TERMINATE_ALWAYS_ON  = UInt64($1) shl 12;
  MITIGATION_POLICY_HEAP_TERMINATE_ALWAYS_OFF = UInt64($2) shl 12;

  MITIGATION_POLICY_BOTTOM_UP_ASLR_ALWAYS_ON  = UInt64($1) shl 16;
  MITIGATION_POLICY_BOTTOM_UP_ASLR_ALWAYS_OFF = UInt64($2) shl 16;

  MITIGATION_POLICY_HIGH_ENTROPY_ASLR_ALWAYS_ON  = UInt64($1) shl 20;
  MITIGATION_POLICY_HIGH_ENTROPY_ASLR_ALWAYS_OFF = UInt64($2) shl 20;

  MITIGATION_POLICY_STRICT_HANDLE_CHECKS_ALWAYS_ON  = UInt64($1) shl 24;
  MITIGATION_POLICY_STRICT_HANDLE_CHECKS_ALWAYS_OFF = UInt64($2) shl 24;

  MITIGATION_POLICY_WIN32K_SYSTEM_CALL_DISABLE_ALWAYS_ON  = UInt64($1) shl 28;
  MITIGATION_POLICY_WIN32K_SYSTEM_CALL_DISABLE_ALWAYS_OFF = UInt64($2) shl 28;
  ...
  MITIGATION_POLICY2_LOADER_INTEGRITY_CONTINUITY_ALWAYS_ON  = UInt64($1) shl 4;
  MITIGATION_POLICY2_LOADER_INTEGRITY_CONTINUITY_ALWAYS_OFF = UInt64($2) shl 4;
  MITIGATION_POLICY2_LOADER_INTEGRITY_CONTINUITY_AUDIT      = UInt64($3) shl 4;

  MITIGATION_POLICY2_STRICT_CONTROL_FLOW_GUARD_ALWAYS_ON  = UInt64($1) shl 8;
  MITIGATION_POLICY2_STRICT_CONTROL_FLOW_GUARD_ALWAYS_OFF = UInt64($2) shl 8;

  // SDK::WinBase.h, Win 10 RS3+
  MITIGATION_POLICY2_MODULE_TAMPERING_PROTECTION_ALWAYS_ON  = UInt64($1) shl 12;
  MITIGATION_POLICY2_MODULE_TAMPERING_PROTECTION_ALWAYS_OFF = UInt64($2) shl 12;
  MITIGATION_POLICY2_MODULE_TAMPERING_PROTECTION_NOINHERIT  = UInt64($3) shl 12;

 // SDK::WinBase.h, Win 10 RS4+
  MITIGATION_POLICY2_RESTRICT_INDIRECT_BRANCH_PREDICTION_ALWAYS_ON  = UInt64($1) shl 16;
  MITIGATION_POLICY2_RESTRICT_INDIRECT_BRANCH_PREDICTION_ALWAYS_OFF = UInt64($2) shl 16;

  // SDK::WinBase.h, Win 10 RS5+
  MITIGATION_POLICY2_ALLOW_DOWNGRADE_DYNAMIC_CODE_POLICY_ALWAYS_ON  = UInt64($1) shl 20;
  MITIGATION_POLICY2_ALLOW_DOWNGRADE_DYNAMIC_CODE_POLICY_ALWAYS_OFF = UInt64($2) shl 20;

  MITIGATION_POLICY2_SPECULATIVE_STORE_BYPASS_DISABLE_ALWAYS_ON  = UInt64($1) shl 24;
  MITIGATION_POLICY2_SPECULATIVE_STORE_BYPASS_DISABLE_ALWAYS_OFF = UInt64($2) shl 24;

  // SDK::WinBase.h, Win 10 20H1+
  MITIGATION_POLICY2_CET_USER_SHADOW_STACKS_ALWAYS_ON   = UInt64($1) shl 28;
  MITIGATION_POLICY2_CET_USER_SHADOW_STACKS_ALWAYS_OFF  = UInt64($2) shl 28;
  MITIGATION_POLICY2_CET_USER_SHADOW_STACKS_STRICT_MODE = UInt64($3) shl 28;
  ...
  MITIGATION_POLICY2_RESTRICT_CORE_SHARING_ALWAYS_OFF = UInt64($2) shl 52;

  // SDK::WinBase.h, Win 11 23H2+
  MITIGATION_POLICY2_FSCTL_SYSTEM_CALL_DISABLE_ALWAYS_ON  = UInt64($1) shl 56;
  MITIGATION_POLICY2_FSCTL_SYSTEM_CALL_DISABLE_ALWAYS_OFF = UInt64($2) shl 56;
...
type
  ...
  [FlagName(NORMAL_PRIORITY_CLASS, 'Normal Priority Class')]
  [FlagName(IDLE_PRIORITY_CLASS, 'Idle Priority Class')]
  [FlagName(HIGH_PRIORITY_CLASS, 'High Priority Class')]
  [FlagName(REALTIME_PRIORITY_CLASS, 'Real-time Priority Class')]
  [FlagName(CREATE_NEW_PROCESS_GROUP, 'New Process Group')]
  [FlagName(CREATE_UNICODE_ENVIRONMENT, 'Unicode Environment')]
  [FlagName(CREATE_SEPARATE_WOW_VDM, 'Create Separate VDM')]
  [FlagName(CREATE_SHARED_WOW_VDM, 'Create Shared VDM')]
  [FlagName(CREATE_FORCEDOS, 'Force DOS')]
  [FlagName(BELOW_NORMAL_PRIORITY_CLASS, 'Below Normal Priority Class')]
  [FlagName(ABOVE_NORMAL_PRIORITY_CLASS, 'Above Normal Priority Class')]
  [FlagName(INHERIT_PARENT_AFFINITY, 'Inherit Parent Affinity')]
  [FlagName(INHERIT_CALLER_PRIORITY, 'Inherit Caller Affinity')]
  [FlagName(CREATE_PROTECTED_PROCESS, 'Protected')]
  [FlagName(EXTENDED_STARTUPINFO_PRESENT, 'Extended Startup Info')]
  [FlagName(PROCESS_MODE_BACKGROUND_BEGIN, 'Backround Mode Begin')]
  [FlagName(PROCESS_MODE_BACKGROUND_END, 'Backround Mode End')]
  [FlagName(CREATE_SECURE_PROCESS, 'Secure')]
  [FlagName(CREATE_BREAKAWAY_FROM_JOB, 'Breakaway From Job')]
  [FlagName(CREATE_PRESERVE_CODE_AUTHZ_LEVEL, 'Preserve Code AuthZ Level')]

...
const
  KnownPrefixes: array [0 .. 98] of String = ('STATUS_VOLMGR_',
    ...
    'ERROR_CLOUD_FILE_', 'ERROR_MRM_', 'E_PDB_', 'ERROR_STATE_', 'ERROR_WMI_',
    'ERROR_DBG_', 'ERROR_APPEXEC_', 'ERROR_SYSTEM_INTEGRITY_',
    'ERROR_PRI_MERGE_', 'ERROR_CAPAUTHZ_', 'ERROR_FT_', 'ERROR_VIRTDISK_',
    'ERROR_RXACT_', 'ERROR_CTLOG_', 'ERROR_CS_ENCRYPTION_',

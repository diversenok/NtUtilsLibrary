...
const
  KnownPrefixes: array [0 .. 100] of String = ('STATUS_VOLMGR_',
    'STATUS_XMLLITE_', 'STATUS_LOG_', 'STATUS_DS_', 'STATUS_CTX_',
    'STATUS_SXS_', 'STATUS_VHD_', 'STATUS_FLT_', 'STATUS_CLOUD_FILE_',
    'STATUS_SMARTCARD_', 'STATUS_APPEXEC_', 'STATUS_SYSTEM_INTEGRITY_',
    'STATUS_WX86_', 'STATUS_WMI_', 'STATUS_DIF_', 'STATUS_FT_', 'STATUS_VRF_',
    'STATUS_PNP_', 'STATUS_THREADPOOL_', 'STATUS_VIRTDISK_', 'STATUS_RXACT_',
    'STATUS_KDC_', 'STATUS_CTLOG_', 'STATUS_CS_ENCRYPTION_',
    'STATUS_TRANSACTIONMANAGER_', 'STATUS_RWRAW_ENCRYPTED_', 'STATUS_BCD_',
    'STATUS_', 'ERROR_VOLMGR_', 'ERROR_SXS_XML_E_', 'ERROR_SXS_', 'ERROR_LOG_',
    'ERROR_CTX_', 'ERROR_INSTALL_', 'ERROR_EVT_', 'ERROR_VHD_',
    'ERROR_CLOUD_FILE_', 'ERROR_MRM_', 'E_PDB_IFC_', 'E_PDB_', 'ERROR_STATE_',
    'ERROR_WMI_', 'ERROR_DBG_', 'ERROR_APPEXEC_', 'ERROR_SYSTEM_INTEGRITY_',
    'ERROR_PRI_MERGE_', 'ERROR_CAPAUTHZ_', 'ERROR_FT_', 'E_DIA_',
    'ERROR_VIRTDISK_', 'ERROR_RXACT_', 'ERROR_CTLOG_', 'ERROR_CS_ENCRYPTION_',
    'ERROR_RWRAW_ENCRYPTED_', 'ERROR_WOF_', 'ERROR_EDP_', 'ERROR_BCD_',
    'ERROR_', 'CO_E_', 'RPC_NT_', 'RPC_S_', 'SEC_E_', 'RPC_E_', 'STG_E_',
    'SCHED_E_', 'E_', 'APPX_E_', 'RPC_X_', 'OLE_E_', 'DISP_E_', 'DISMAPI_E_',
    'MK_E_', 'EVENT_E_', 'DBG_', 'SEC_I_', 'RO_E_', 'WER_S_', 'SCHED_S_',
    'CS_E_', 'CONTEXT_E_', 'WER_E_', 'STG_S_', 'REGDB_E_', 'APPMODEL_ERROR_',
    'DWM_E_', 'MK_S_', 'CLIPBRD_E_', 'STORE_ERROR_', 'S_', 'EPT_S_', 'EPT_NT_',
    'OR_', 'OLEOBJ_S_', 'OLE_S_', 'MEM_E_', 'CLASS_E_', 'OLEOBJ_E_', 'EVENT_S_',
    'DWM_S_', 'CO_S_', 'CAT_E_');
var
  Prefix: String;
begin
